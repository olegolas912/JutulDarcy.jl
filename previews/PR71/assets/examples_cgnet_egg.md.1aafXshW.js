import{_ as a,c as n,a5 as i,o as p}from"./chunks/framework.6qKTFhuU.js";const l="/JutulDarcy.jl/previews/PR71/assets/qwpagms.8F-uJYXO.jpeg",e="/JutulDarcy.jl/previews/PR71/assets/utpfghd.BJ5CGAfL.jpeg",t="/JutulDarcy.jl/previews/PR71/assets/xssftpr.1SA6Q7zu.jpeg",h="/JutulDarcy.jl/previews/PR71/assets/xntxsls.YLwJCPAY.jpeg",k="/JutulDarcy.jl/previews/PR71/assets/lutnlhz.CEIrwd02.jpeg",r="/JutulDarcy.jl/previews/PR71/assets/ietmiwo.B-1y9xUg.jpeg",E="/JutulDarcy.jl/previews/PR71/assets/vapcbcn.BN_mow0X.jpeg",c="/JutulDarcy.jl/previews/PR71/assets/ymfjkfg.OqlvKTPp.jpeg",d="/JutulDarcy.jl/previews/PR71/assets/wjlatsy.B0fFwT7t.jpeg",o="/JutulDarcy.jl/previews/PR71/assets/fwffqfk.436aRUeQ.jpeg",g="/JutulDarcy.jl/previews/PR71/assets/vsheskn.BwASt21d.jpeg",u="/JutulDarcy.jl/previews/PR71/assets/xeqvjlg.BXe6X6ae.jpeg",y="/JutulDarcy.jl/previews/PR71/assets/abqnmrj.Ck-5FtiC.jpeg",v=JSON.parse('{"title":"History matching a coarse model - CGNet","description":"","frontmatter":{},"headers":[],"relativePath":"examples/cgnet_egg.md","filePath":"examples/cgnet_egg.md","lastUpdated":null}'),b={name:"examples/cgnet_egg.md"};function F(m,s,C,A,D,f){return p(),n("div",null,s[0]||(s[0]=[i(`<h1 id="History-matching-a-coarse-model-CGNet" tabindex="-1">History matching a coarse model - CGNet <a class="header-anchor" href="#History-matching-a-coarse-model-CGNet" aria-label="Permalink to &quot;History matching a coarse model - CGNet {#History-matching-a-coarse-model-CGNet}&quot;">​</a></h1><p>This example demonstrates how to calibrate a coarse model against results from a fine model. We do this by optimizing the parameters of the coarse model to match the well curves. This is a implementation of the method described in [<a href="/JutulDarcy.jl/previews/PR71/extras/refs#cgnet1">7</a>]. This also serves as a demonstration of how to use the simulator for history matching, as the fine model results can stand in for real field observations.</p><h2 id="Load-and-simulate-Egg-base-case" tabindex="-1">Load and simulate Egg base case <a class="header-anchor" href="#Load-and-simulate-Egg-base-case" aria-label="Permalink to &quot;Load and simulate Egg base case {#Load-and-simulate-Egg-base-case}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Jutul, JutulDarcy, HYPRE, GeoEnergyIO, GLMakie</span></span>
...
<span class="line"><span>└─────────────┴──────────────┴───┴─────────┴─────────────┴────────────────┴──────────────────────┴─────────┘</span></span>
<span class="line"><span>#1: 3.7373302810581173</span></span>
<span class="line"><span>Initial objective: 3.7373302810581173, gradient norm 2.983773972465357e6</span></span>
...
<span class="line"><span>┌ Warning: Partial data passed, objective set to large value 37.37330281058117.</span></span>
<span class="line"><span>└ @ Jutul ~/.julia/packages/Jutul/VbNFh/src/ad/gradients.jl:682</span></span>
<span class="line"><span>#2: 37.37330281058117</span></span>
...
<span class="line"><span>\x1B[31;1mPROD1:\x1B[0m Approaching zero rate, disabling producer for current step</span></span>
<span class="line"><span>\x1B[31;1mPROD1:\x1B[0m Approaching zero rate, disabling producer for current step</span></span>
<span class="line"><span>#3: 65.01329948286727</span></span>
<span class="line"><span>\x1B[31;1mPROD1:\x1B[0m Approaching zero rate, disabling producer for current step</span></span>
<span class="line"><span>\x1B[31;1mPROD1:\x1B[0m Approaching zero rate, disabling producer for current step</span></span>
<span class="line"><span>\x1B[31;1mPROD1:\x1B[0m Approaching zero rate, disabling producer for current step</span></span>
<span class="line"><span>\x1B[31;1mPROD1:\x1B[0m Approaching zero rate, disabling producer for current step</span></span>
...
<span class="line"><span>\x1B[31;1mPROD1:\x1B[0m Approaching zero rate, disabling producer for current step</span></span>
<span class="line"><span>\x1B[31;1mPROD1:\x1B[0m Approaching zero rate, disabling producer for current step</span></span>
<span class="line"><span>#4: 64.00312090479714</span></span>
<span class="line"><span>#5: 62.026116365306535</span></span>
<span class="line"><span>#6: 58.23201287244935</span></span>
<span class="line"><span>#7: 47.43573546600407</span></span>
<span class="line"><span>#8: 26.596516029209578</span></span>
<span class="line"><span>#9: 7.439002071214933</span></span>
<span class="line"><span>#10: 0.607355568500212</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate    1    f=  6.07356D-01    |proj g|=  9.99000D-01</span></span>
<span class="line"><span>#11: 0.2931232022816694</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate    2    f=  2.93123D-01    |proj g|=  9.99000D-01</span></span>
<span class="line"><span>#12: 0.19240938697830032</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate    3    f=  1.92409D-01    |proj g|=  9.99000D-01</span></span>
<span class="line"><span>#13: 0.17230182149941603</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate    4    f=  1.72302D-01    |proj g|=  9.99000D-01</span></span>
<span class="line"><span>#14: 0.16527387286412265</span></span>
<span class="line"><span>#15: 0.14215780529802266</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate    5    f=  1.42158D-01    |proj g|=  9.99000D-01</span></span>
<span class="line"><span>#16: 0.12780219191760642</span></span>
<span class="line"><span>#17: 0.12601119693104737</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate    6    f=  1.26011D-01    |proj g|=  9.99001D-01</span></span>
<span class="line"><span>#18: 0.11894041426445714</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate    7    f=  1.18940D-01    |proj g|=  9.99006D-01</span></span>
<span class="line"><span>#19: 0.1136723350787393</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate    8    f=  1.13672D-01    |proj g|=  9.99006D-01</span></span>
<span class="line"><span>#20: 0.10834286997692137</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate    9    f=  1.08343D-01    |proj g|=  9.99008D-01</span></span>
<span class="line"><span>#21: 0.10199837327697019</span></span>
<span class="line"><span>#22: 0.10355406443666638</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate   10    f=  1.03554D-01    |proj g|=  9.99009D-01</span></span>
<span class="line"><span>#23: 0.13838261788043027</span></span>
<span class="line"><span>#24: 0.09408207722006041</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate   11    f=  9.40821D-02    |proj g|=  9.99008D-01</span></span>
<span class="line"><span>#25: 0.09395968818850925</span></span>
<span class="line"><span></span></span>
<span class="line"><span>At iterate   12    f=  9.39597D-02    |proj g|=  9.99012D-01</span></span>
<span class="line"><span></span></span>
<span class="line"><span>           * * *</span></span>
<span class="line"><span></span></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">simulated_tuned </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> simulate_reservoir</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tuned_case);</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps   2%  ETA: 0:00:05\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 3/135 (0.28% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     15 iterations in 121.51 ms (8.10 ms each)\x1B[K</span></span>
...
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps   6%  ETA: 0:00:05\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 8/135 (1.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     39 iterations in 277.28 ms (7.11 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  10%  ETA: 0:00:04\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 13/135 (3.33% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     57 iterations in 392.07 ms (6.88 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  12%  ETA: 0:00:04\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 17/135 (5.00% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     73 iterations in 495.79 ms (6.79 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  15%  ETA: 0:00:04\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 21/135 (6.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     89 iterations in 602.97 ms (6.77 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  18%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 25/135 (8.33% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     106 iterations in 716.36 ms (6.76 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  21%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 29/135 (11.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     129 iterations in 873.77 ms (6.77 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  24%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 32/135 (14.17% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     143 iterations in 977.17 ms (6.83 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  26%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 35/135 (16.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     158 iterations in 1.09 s (6.87 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  29%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 39/135 (20.00% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     174 iterations in 1.20 s (6.93 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  32%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 43/135 (23.33% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     188 iterations in 1.31 s (6.97 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  35%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 47/135 (26.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     202 iterations in 1.42 s (7.01 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  38%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 52/135 (30.83% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     218 iterations in 1.54 s (7.05 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  42%  ETA: 0:00:02\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 57/135 (35.00% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     233 iterations in 1.69 s (7.27 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  46%  ETA: 0:00:02\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 62/135 (39.17% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     248 iterations in 1.80 s (7.28 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  49%  ETA: 0:00:02\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 67/135 (43.33% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     262 iterations in 1.91 s (7.29 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  54%  ETA: 0:00:02\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 73/135 (48.33% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     276 iterations in 2.02 s (7.31 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  59%  ETA: 0:00:02\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 80/135 (54.17% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     291 iterations in 2.13 s (7.33 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  64%  ETA: 0:00:01\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 87/135 (60.00% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     306 iterations in 2.25 s (7.34 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  68%  ETA: 0:00:01\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 93/135 (65.00% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     319 iterations in 2.35 s (7.36 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  74%  ETA: 0:00:01\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 100/135 (70.83% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     333 iterations in 2.46 s (7.38 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  79%  ETA: 0:00:01\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 107/135 (76.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     347 iterations in 2.57 s (7.40 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  84%  ETA: 0:00:01\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 114/135 (82.50% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     361 iterations in 2.68 s (7.41 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  88%  ETA: 0:00:00\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 120/135 (87.50% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     374 iterations in 2.78 s (7.43 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  93%  ETA: 0:00:00\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 127/135 (93.33% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     388 iterations in 2.89 s (7.44 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  99%  ETA: 0:00:00\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 134/135 (99.17% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     402 iterations in 3.00 s (7.45 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps 100% Time: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solved step 135/135\x1B[K</span></span>
<span class="line"><span>  Stats:     406 iterations in 3.03 s (7.46 ms each)\x1B[K</span></span>
<span class="line"><span>╭────────────────┬───────────┬───────────────┬──────────╮</span></span>
<span class="line"><span>│ Iteration type │  Avg/step │  Avg/ministep │    Total │</span></span>
<span class="line"><span>│                │ 135 steps │ 141 ministeps │ (wasted) │</span></span>
<span class="line"><span>├────────────────┼───────────┼───────────────┼──────────┤</span></span>
<span class="line"><span>│ Newton         │   3.00741 │       2.87943 │  406 (0) │</span></span>
<span class="line"><span>│ Linearization  │   4.05185 │       3.87943 │  547 (0) │</span></span>
<span class="line"><span>│ Linear solver  │   13.3111 │       12.7447 │ 1797 (0) │</span></span>
<span class="line"><span>│ Precond apply  │   26.6222 │       25.4894 │ 3594 (0) │</span></span>
<span class="line"><span>╰────────────────┴───────────┴───────────────┴──────────╯</span></span>
<span class="line"><span>╭───────────────┬────────┬────────────┬────────╮</span></span>
<span class="line"><span>│ Timing type   │   Each │   Relative │  Total │</span></span>
<span class="line"><span>│               │     ms │ Percentage │      s │</span></span>
<span class="line"><span>├───────────────┼────────┼────────────┼────────┤</span></span>
<span class="line"><span>│ Properties    │ 0.3080 │     4.13 % │ 0.1250 │</span></span>
<span class="line"><span>│ Equations     │ 0.4465 │     8.07 % │ 0.2442 │</span></span>
<span class="line"><span>│ Assembly      │ 0.4788 │     8.65 % │ 0.2619 │</span></span>
<span class="line"><span>│ Linear solve  │ 0.4311 │     5.78 % │ 0.1750 │</span></span>
<span class="line"><span>│ Linear setup  │ 3.0503 │    40.91 % │ 1.2384 │</span></span>
<span class="line"><span>│ Precond apply │ 0.2116 │    25.12 % │ 0.7605 │</span></span>
<span class="line"><span>│ Update        │ 0.1350 │     1.81 % │ 0.0548 │</span></span>
<span class="line"><span>│ Convergence   │ 0.1585 │     2.86 % │ 0.0867 │</span></span>
<span class="line"><span>│ Input/Output  │ 0.0650 │     0.30 % │ 0.0092 │</span></span>
<span class="line"><span>│ Other         │ 0.1769 │     2.37 % │ 0.0718 │</span></span>
<span class="line"><span>├───────────────┼────────┼────────────┼────────┤</span></span>
<span class="line"><span>│ Total         │ 7.4570 │   100.00 % │ 3.0275 │</span></span>
<span class="line"><span>╰───────────────┴────────┴────────────┴────────╯</span></span></code></pre></div><h3 id="Plot-the-results-interactively" tabindex="-1">Plot the results interactively <a class="header-anchor" href="#Plot-the-results-interactively" aria-label="Permalink to &quot;Plot the results interactively {#Plot-the-results-interactively}&quot;">​</a></h3><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> GLMakie</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>plot_tuned_well (generic function with 1 method)</span></span></code></pre></div><h3 id="Plot-PROD1-water-cut" tabindex="-1">Plot PROD1 water cut <a class="header-anchor" href="#Plot-PROD1-water-cut" aria-label="Permalink to &quot;Plot PROD1 water cut {#Plot-PROD1-water-cut}&quot;">​</a></h3><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">plot_tuned_well</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:PROD1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:wcut</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p><img src="`+h+'" alt=""></p><h3 id="Plot-PROD2-water-cut" tabindex="-1">Plot PROD2 water cut <a class="header-anchor" href="#Plot-PROD2-water-cut" aria-label="Permalink to &quot;Plot PROD2 water cut {#Plot-PROD2-water-cut}&quot;">​</a></h3><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">plot_tuned_well</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:PROD2</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:wcut</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p><img src="'+k+'" alt=""></p><h3 id="Plot-PROD4-water-cut" tabindex="-1">Plot PROD4 water cut <a class="header-anchor" href="#Plot-PROD4-water-cut" aria-label="Permalink to &quot;Plot PROD4 water cut {#Plot-PROD4-water-cut}&quot;">​</a></h3><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">plot_tuned_well</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:PROD4</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:wcut</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p><img src="'+r+'" alt=""></p><h3 id="Plot-PROD1-total-rate" tabindex="-1">Plot PROD1 total rate <a class="header-anchor" href="#Plot-PROD1-total-rate" aria-label="Permalink to &quot;Plot PROD1 total rate {#Plot-PROD1-total-rate}&quot;">​</a></h3><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">plot_tuned_well</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:PROD1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:rate</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p><img src="'+E+'" alt=""></p><h3 id="Plot-PROD2-total-rate" tabindex="-1">Plot PROD2 total rate <a class="header-anchor" href="#Plot-PROD2-total-rate" aria-label="Permalink to &quot;Plot PROD2 total rate {#Plot-PROD2-total-rate}&quot;">​</a></h3><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">plot_tuned_well</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:PROD2</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:rate</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p><img src="'+c+'" alt=""></p><h3 id="Plot-PROD4-total-rate" tabindex="-1">Plot PROD4 total rate <a class="header-anchor" href="#Plot-PROD4-total-rate" aria-label="Permalink to &quot;Plot PROD4 total rate {#Plot-PROD4-total-rate}&quot;">​</a></h3><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">plot_tuned_well</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:PROD4</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:rate</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p><img src="'+d+'" alt=""></p><h3 id="Plot-INJECT1-bhp" tabindex="-1">Plot INJECT1 bhp <a class="header-anchor" href="#Plot-INJECT1-bhp" aria-label="Permalink to &quot;Plot INJECT1 bhp {#Plot-INJECT1-bhp}&quot;">​</a></h3><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">plot_tuned_well</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:INJECT1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:bhp</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, lposition </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> :rt</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p><img src="'+o+'" alt=""></p><h3 id="Plot-INJECT4-bhp" tabindex="-1">Plot INJECT4 bhp <a class="header-anchor" href="#Plot-INJECT4-bhp" aria-label="Permalink to &quot;Plot INJECT4 bhp {#Plot-INJECT4-bhp}&quot;">​</a></h3><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">plot_tuned_well</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:INJECT4</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:bhp</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, lposition </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> :rt</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p><img src="'+g+`" alt=""></p><h2 id="Plot-the-objective-evaluations-during-optimization" tabindex="-1">Plot the objective evaluations during optimization <a class="header-anchor" href="#Plot-the-objective-evaluations-during-optimization" aria-label="Permalink to &quot;Plot the objective evaluations during optimization {#Plot-the-objective-evaluations-during-optimization}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">fig </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Figure</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">()</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">lines!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(ax1, setup[</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:lower</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">], label </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;Lower bound&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>MakieCore.Lines{Tuple{Vector{GeometryBasics.Point{2, Float64}}}}</span></span></code></pre></div><p>lines!(ax1, setup[:upper], label = &quot;Upper bound&quot;)</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">axislegend</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">()</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">fig</span></span></code></pre></div><p><img src="`+y+'" alt=""></p><h2 id="Example-on-GitHub" tabindex="-1">Example on GitHub <a class="header-anchor" href="#Example-on-GitHub" aria-label="Permalink to &quot;Example on GitHub {#Example-on-GitHub}&quot;">​</a></h2><p>If you would like to run this example yourself, it can be downloaded from the JutulDarcy.jl GitHub repository <a href="https://github.com/sintefmath/JutulDarcy.jl/blob/main/examples/cgnet_egg.jl" target="_blank" rel="noreferrer">as a script</a>, or as a <a href="https://github.com/sintefmath/JutulDarcy.jl/blob/gh-pages/dev/final_site/notebooks/cgnet_egg.ipynb" target="_blank" rel="noreferrer">Jupyter Notebook</a></p><hr><p><em>This page was generated using <a href="https://github.com/fredrikekre/Literate.jl" target="_blank" rel="noreferrer">Literate.jl</a>.</em></p>',70)]))}const B=a(b,[["render",F]]);export{v as __pageData,B as default};
