import{_ as a,c as n,a5 as i,o as p}from"./chunks/framework.6qKTFhuU.js";const l="/JutulDarcy.jl/previews/PR71/assets/geavhpm.8F-uJYXO.jpeg",e="/JutulDarcy.jl/previews/PR71/assets/axsibpx.BJ5CGAfL.jpeg",t="/JutulDarcy.jl/previews/PR71/assets/uaoebxf.1SA6Q7zu.jpeg",h="/JutulDarcy.jl/previews/PR71/assets/jqqzjea.YLwJCPAY.jpeg",k="/JutulDarcy.jl/previews/PR71/assets/jjmzccu.CEIrwd02.jpeg",r="/JutulDarcy.jl/previews/PR71/assets/zkxvgwf.B-1y9xUg.jpeg",E="/JutulDarcy.jl/previews/PR71/assets/biyxyqv.BN_mow0X.jpeg",c="/JutulDarcy.jl/previews/PR71/assets/ennqwlz.OqlvKTPp.jpeg",d="/JutulDarcy.jl/previews/PR71/assets/mumeibc.B0fFwT7t.jpeg",o="/JutulDarcy.jl/previews/PR71/assets/wwmmjmb.436aRUeQ.jpeg",g="/JutulDarcy.jl/previews/PR71/assets/slpwues.BwASt21d.jpeg",u="/JutulDarcy.jl/previews/PR71/assets/eilmqwz.BXe6X6ae.jpeg",y="/JutulDarcy.jl/previews/PR71/assets/itltisb.Ck-5FtiC.jpeg",v=JSON.parse('{"title":"History matching a coarse model - CGNet","description":"","frontmatter":{},"headers":[],"relativePath":"examples/cgnet_egg.md","filePath":"examples/cgnet_egg.md","lastUpdated":null}'),b={name:"examples/cgnet_egg.md"};function F(m,s,C,A,D,f){return p(),n("div",null,s[0]||(s[0]=[i(`<h1 id="History-matching-a-coarse-model-CGNet" tabindex="-1">History matching a coarse model - CGNet <a class="header-anchor" href="#History-matching-a-coarse-model-CGNet" aria-label="Permalink to &quot;History matching a coarse model - CGNet {#History-matching-a-coarse-model-CGNet}&quot;">​</a></h1><p>This example demonstrates how to calibrate a coarse model against results from a fine model. We do this by optimizing the parameters of the coarse model to match the well curves. This is a implementation of the method described in [<a href="/JutulDarcy.jl/previews/PR71/extras/refs#cgnet1">7</a>]. This also serves as a demonstration of how to use the simulator for history matching, as the fine model results can stand in for real field observations.</p><h2 id="Load-and-simulate-Egg-base-case" tabindex="-1">Load and simulate Egg base case <a class="header-anchor" href="#Load-and-simulate-Egg-base-case" aria-label="Permalink to &quot;Load and simulate Egg base case {#Load-and-simulate-Egg-base-case}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Jutul, JutulDarcy, HYPRE, GeoEnergyIO, GLMakie</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span> Cauchy                time 3.876E-03 seconds.</span></span>
...
<span class="line"><span>  Stats:     15 iterations in 120.00 ms (8.00 ms each)\x1B[K</span></span>
...
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps   4%  ETA: 0:00:05\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 6/135 (1.11% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     31 iterations in 220.93 ms (7.13 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps   7%  ETA: 0:00:04\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 10/135 (2.22% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     47 iterations in 323.78 ms (6.89 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  11%  ETA: 0:00:04\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 15/135 (4.17% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     65 iterations in 439.59 ms (6.76 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  14%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 19/135 (5.83% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     81 iterations in 545.91 ms (6.74 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  17%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 23/135 (7.50% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     97 iterations in 655.85 ms (6.76 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  20%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 27/135 (10.00% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     117 iterations in 788.03 ms (6.74 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  22%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 30/135 (12.50% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     134 iterations in 907.81 ms (6.77 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  Progress:  Solving step 33/135 (15.00% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     148 iterations in 1.01 s (6.83 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  Progress:  Solving step 36/135 (17.50% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     162 iterations in 1.11 s (6.87 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  Progress:  Solving step 40/135 (20.83% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     178 iterations in 1.23 s (6.93 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  33%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 45/135 (25.00% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     195 iterations in 1.41 s (7.23 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  37%  ETA: 0:00:03\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 50/135 (29.17% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     211 iterations in 1.53 s (7.24 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  40%  ETA: 0:00:02\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 55/135 (33.33% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     227 iterations in 1.64 s (7.24 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  44%  ETA: 0:00:02\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 60/135 (37.50% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     242 iterations in 1.75 s (7.24 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  48%  ETA: 0:00:02\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 65/135 (41.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     257 iterations in 1.86 s (7.25 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  52%  ETA: 0:00:02\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 71/135 (46.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     272 iterations in 1.98 s (7.27 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  57%  ETA: 0:00:02\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 78/135 (52.50% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     287 iterations in 2.09 s (7.29 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  62%  ETA: 0:00:01\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 85/135 (58.33% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     302 iterations in 2.21 s (7.31 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  Progress:  Solving step 92/135 (64.17% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     316 iterations in 2.32 s (7.34 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  73%  ETA: 0:00:01\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 99/135 (70.00% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     331 iterations in 2.43 s (7.35 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  78%  ETA: 0:00:01\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 106/135 (75.83% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     345 iterations in 2.54 s (7.36 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  83%  ETA: 0:00:01\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 113/135 (81.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     359 iterations in 2.65 s (7.39 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  Progress:  Solving step 119/135 (86.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     372 iterations in 2.76 s (7.41 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  Progress:  Solving step 126/135 (92.50% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     386 iterations in 2.87 s (7.43 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>\x1B[K\x1B[A</span></span>
<span class="line"><span>Simulating 9 years, 44.69 weeks as 135 report steps  96%  ETA: 0:00:00\x1B[K</span></span>
<span class="line"><span>  Progress:  Solving step 131/135 (96.67% of time interval complete)\x1B[K</span></span>
<span class="line"><span>  Stats:     396 iterations in 2.99 s (7.56 ms each)\x1B[K</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span>\x1B[A</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  Stats:     406 iterations in 3.07 s (7.57 ms each)\x1B[K</span></span>
<span class="line"><span>╭────────────────┬───────────┬───────────────┬──────────╮</span></span>
...
<span class="line"><span>├───────────────┼────────┼────────────┼────────┤</span></span>
<span class="line"><span>│ Properties    │ 0.3120 │     4.12 % │ 0.1267 │</span></span>
<span class="line"><span>│ Equations     │ 0.4459 │     7.94 % │ 0.2439 │</span></span>
<span class="line"><span>│ Assembly      │ 0.4223 │     7.52 % │ 0.2310 │</span></span>
<span class="line"><span>│ Linear solve  │ 0.4305 │     5.69 % │ 0.1748 │</span></span>
<span class="line"><span>│ Linear setup  │ 3.1432 │    41.54 % │ 1.2761 │</span></span>
<span class="line"><span>│ Precond apply │ 0.2100 │    24.56 % │ 0.7547 │</span></span>
<span class="line"><span>│ Update        │ 0.1352 │     1.79 % │ 0.0549 │</span></span>
<span class="line"><span>│ Convergence   │ 0.2425 │     4.32 % │ 0.1326 │</span></span>
<span class="line"><span>│ Input/Output  │ 0.0620 │     0.28 % │ 0.0087 │</span></span>
<span class="line"><span>│ Other         │ 0.1698 │     2.24 % │ 0.0689 │</span></span>
<span class="line"><span>├───────────────┼────────┼────────────┼────────┤</span></span>
<span class="line"><span>│ Total         │ 7.5675 │   100.00 % │ 3.0724 │</span></span>
