import{_ as a,c as n,a5 as i,o as l}from"./chunks/framework.FQe81xu_.js";const p="/JutulDarcy.jl/dev/assets/dlakjno.B1sPN_Nt.jpeg",e="/JutulDarcy.jl/dev/assets/xlzuzld.Brwtv7GN.jpeg",t="/JutulDarcy.jl/dev/assets/cpcwchi.DjTcxNdM.jpeg",h="/JutulDarcy.jl/dev/assets/ctyylln.DNnr_GMF.jpeg",k="/JutulDarcy.jl/dev/assets/ralkprw.DbrLV50a.jpeg",r="/JutulDarcy.jl/dev/assets/oqzvkmv.B7zeVHZB.jpeg",o="/JutulDarcy.jl/dev/assets/wsymsuf.BFBC7-7s.jpeg",E="/JutulDarcy.jl/dev/assets/aambvak.DblDeRjZ.jpeg",c="/JutulDarcy.jl/dev/assets/yzbvaky.C4sk0eSO.jpeg",D=JSON.parse('{"title":"Norne: Real field black-oil model","description":"","frontmatter":{},"headers":[],"relativePath":"examples/validation_norne_nohyst.md","filePath":"examples/validation_norne_nohyst.md","lastUpdated":null}'),d={name:"examples/validation_norne_nohyst.md"};function y(g,s,F,u,m,C){return l(),n("div",null,s[0]||(s[0]=[i(`<h1 id="Norne:-Real-field-black-oil-model" tabindex="-1">Norne: Real field black-oil model <a class="header-anchor" href="#Norne:-Real-field-black-oil-model" aria-label="Permalink to &quot;Norne: Real field black-oil model {#Norne:-Real-field-black-oil-model}&quot;">​</a></h1><p>The Norne model is a real field model. The model has been adapted so that the input file only contains features present in JutulDarcy, with the most notable omissions being removal of hysteresis and threshold pressures between equilibriation reqgions. For more details, see the <a href="https://opm-project.org/?page_id=559" target="_blank" rel="noreferrer">OPM data webpage</a></p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Jutul, JutulDarcy, GLMakie, DelimitedFiles, HYPRE, GeoEnergyIO</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>MultiModel with 38 models and 108 cross-terms. 133395 equations, 133395 degrees of freedom and 1065934 parameters.</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>       ∈ MinimalTPFATopology (44417 cells, 132693 faces)</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ax</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">azimuth[] </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> -</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">3.0</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ax</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">elevation[] </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 0.5</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">fig</span></span></code></pre></div><p><img src="`+e+`" alt=""></p><h2 id="Simulate-the-model" tabindex="-1">Simulate the model <a class="header-anchor" href="#Simulate-the-model" aria-label="Permalink to &quot;Simulate the model {#Simulate-the-model}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ws, states </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> simulate_reservoir</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(case, output_substates </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> true</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>ReservoirSimResult with 789 entries:</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>       :wrat =&gt; Vector{Float64} of size (789,)</span></span>
<span class="line"><span>       :Aqueous_mass_rate =&gt; Vector{Float64} of size (789,)</span></span>
<span class="line"><span>       :orat =&gt; Vector{Float64} of size (789,)</span></span>
<span class="line"><span>       :bhp =&gt; Vector{Float64} of size (789,)</span></span>
<span class="line"><span>       :lrat =&gt; Vector{Float64} of size (789,)</span></span>
<span class="line"><span>       :mass_rate =&gt; Vector{Float64} of size (789,)</span></span>
<span class="line"><span>       :rate =&gt; Vector{Float64} of size (789,)</span></span>
<span class="line"><span>       :Vapor_mass_rate =&gt; Vector{Float64} of size (789,)</span></span>
<span class="line"><span>       :control =&gt; Vector{Symbol} of size (789,)</span></span>
<span class="line"><span>       :Liquid_mass_rate =&gt; Vector{Float64} of size (789,)</span></span>
<span class="line"><span>       :grat =&gt; Vector{Float64} of size (789,)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  states (Vector with 789 entries, reservoir variables for each state)</span></span>
...
<span class="line"><span>     Vector{Float64} of length 789</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>  Completed at Sep. 24 2024 18:09 after 22 minutes, 44 seconds, 433.6 milliseconds.</span></span></code></pre></div><h2 id="Plot-the-reservoir-solution" tabindex="-1">Plot the reservoir solution <a class="header-anchor" href="#Plot-the-reservoir-solution" aria-label="Permalink to &quot;Plot the reservoir solution {#Plot-the-reservoir-solution}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">fig </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> plot_reservoir</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(model, states, step </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 247</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, key </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> :Saturations</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ax </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> fig</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">current_axis[]</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ax</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">azimuth[] </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> -</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">3.0</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ax</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">elevation[] </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 0.5</span></span>
